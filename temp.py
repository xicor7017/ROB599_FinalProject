...
class CubeTracker:
    ...
    def track(self):
        ...
        if area_contour is not None and area > 2500:
            ...
            if True:
                self.draw_track(img, img_h, img_w, box)
            print(world_x, world_y, self.cube_rotation)
            return world_x, world_y, self.cube_rotation
        return None

    def draw_track(self, img, img_h, img_w, box):
...
if __name__ == '__main__':
    ...
    timer_bus = rossros.Bus(name='timerbus')
